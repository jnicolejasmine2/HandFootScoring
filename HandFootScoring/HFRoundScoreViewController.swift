//
//  HFRoundScoreViewController.swift
//  HandFootScoring
//
//  Created by Jeanne Nicole Byers on 3/13/16.
...
class HFRoundScoreViewController: UIViewController, NSFetchedResultsControllerDelegate, CardCountViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if selectedTeamNumber == 1 {
            ...
            loadScoreValues(3, option: "Other3")
            ...
            loadScoreValues(2, option: "Other3")
